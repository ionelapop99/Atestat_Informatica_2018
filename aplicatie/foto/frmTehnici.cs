...
namespace foto
{
    public partial class frmTehnici : Form
    {
        public frmTehnici()
        {
            InitializeComponent();
        ...
        {
            afiseaza("/surse/1.2Tehnica_albnegru.txt");
        }
        ...
        {
            afiseaza("/surse/1.2tehnica_HDR.txt");
        }

        private void label5_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2foto_artificii.txt");
        }

        private void label4_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2Fotografia_culinară.txt");
        }

        private void label6_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2Fotografia_de_studio.txt");
        }

        private void label8_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2Fotografie_fum.txt");
            
        }

        private void Foto(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2Fotografia_submarină.txt");
        }

        private void label9_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2Fotografierea_picaturi.txt");
        }

        private void label10_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2Fotografierea_zăpezii.txt");
        }

        private void label11_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2fotografiile-de-noapte.txt");
        }

        private void label14_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2Tehnica_expunere-lunga.txt");
            
        }

        private void label16_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2Tehnica_Light-pinting.txt");
        }

        private void label12_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2Tehnica_low_keyhigh_key.txt");
        }

        private void label13_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2Tehnica_tilt-shift.txt");
        }

        private void label15_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2Tehnica-contre –jour.txt");
        }

        private void label17_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2-tehnica-infrarosului.txt");
        }
        ...
        private void frmTehnici_Load(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2Tehnica_albnegru.txt");
            bordura(5);
        }
