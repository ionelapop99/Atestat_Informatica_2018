...
namespace foto
{
    public partial class frmCuriozitati : Form
    {
        public frmCuriozitati()
        {
            InitializeComponent();
        }
        ...
        {
            afiseaza("/surse/4.1Curiozitati.txt");
        }

        private void lblP2_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/4.2Curiozitati.txt");
        }
        ...
        private void frmCuriozitati_Load(object sender, EventArgs e)
        {
            afiseaza("/surse/4.1Curiozitati.txt");
            bordura(5);
        }
