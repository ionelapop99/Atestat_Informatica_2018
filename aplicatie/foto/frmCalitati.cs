...
namespace foto
{
    public partial class frmCalitati : Form
    {
        public frmCalitati()
        {
            InitializeComponent();
        ...
        {
            afiseaza("/surse/1.2.Calitatile_de_baza_a_unui_bun_fotograf.txt");
        }

        private void lblP2_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/istoric2.txt");
        }
        ...
        private void frmCalitati_Load(object sender, EventArgs e)
        {
            afiseaza("/surse/1.2.Calitatile_de_baza_a_unui_bun_fotograf.txt");
            bordura(5);
        }
