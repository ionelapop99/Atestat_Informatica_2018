...
namespace foto
{
    public partial class frmAparitia1 : Form
    {
        public frmAparitia1()
        {
            InitializeComponent();
        ...
        {
            afiseaza("/surse/3.1.Aparitia_in_romania.txt");
        }

        private void lblP2_Click(object sender, EventArgs e)
        {
            afiseaza("/surse/3.2.Aparitia_in_romania.txt");
        }
        ...
        private void frmAparitia1_Load(object sender, EventArgs e)
        {
            afiseaza("/surse/3.1.Aparitia_in_romania.txt");
            bordura(5);
        }
